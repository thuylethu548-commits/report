...
(() => {
    ...
    root.setAttribute('aria-label', 'Thiên Cơ Các — giao diện khám phá');
    root.innerHTML = `
        ...
        <div class="cult-toolbar"><span>Giao diện trang trí • Không điều khiển giao dịch</span><span class="cult-rank"></span></div>
        ...
        <div class="cult-bottom"><section class="cult-detail" aria-live="polite" aria-atomic="true">
            ...
            <p class="cult-evidence">Vai trò và dữ liệu lấy từ bảng hiện có. Hoạt ảnh chỉ là trang trí, không xác nhận agent đang làm việc.</p>
